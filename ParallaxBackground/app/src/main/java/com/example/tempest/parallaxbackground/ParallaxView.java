package com.example.tempest.parallaxbackground;
...
public class ParallaxView extends SurfaceView implements Runnable {
    ...
    ParallaxView(Context context, int screenWidth, int screenHeight) {
        ...
        backgrounds.add(new Background(this.context, screenWidth, screenHeight, "grass", 70, 110, 220));
    ...
    private void draw() {
        if (ourHolder.getSurface().isValid()) {
            ...
            canvas.drawText("Bird? Plane? Superman?", 350, screenHeight / 100*5, paint);
            paint.setTextSize(220);
            canvas.drawText("Train", 50, screenHeight / 100*80, paint);
